-- CreateEnum
CREATE TYPE "RoleUsers" AS ENUM ('ADMIN', 'MEMBER');

-- CreateEnum
CREATE TYPE "StatusTasks" AS ENUM ('PENDING', 'IN_PROCESS', 'COMPLETED');

-- CreateEnum
CREATE TYPE "PriorityTasks" AS ENUM ('HIGH', 'MEDIUM', 'LOW');
...
CREATE TABLE "users" (
    ...
    "role" "RoleUsers" NOT NULL DEFAULT 'MEMBER',
